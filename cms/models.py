...
class System(models.Model):
    ...
    total_profits = models.DecimalField(max_digits=15, decimal_places=4 ,blank=True, null=True)
    copy_traders = models.CharField(max_length=50 ,blank=True, null=True)
    AUM = models.CharField(max_length=50 ,blank=True, null=True)
    max_drawdown = models.DecimalField(max_digits=15, decimal_places=4 ,blank=True, null=True)
